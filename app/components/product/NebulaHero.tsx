...
export function NebulaHero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ backgroundColor: '#03050C' }}>
      {/* ── Custom Keyframes CSS Animation Definitions ── */}
      <style suppressHydrationWarning>{`
        ...
        .anim-fade-zoom-up { animation: fade-zoom-up 1.2s cubic-bezier(0.16, 1, 0.3, 1) forwards; opacity: 0; }
        ...
        /* Inner gradient background clip text fallback */
        .text-gradient-bg {
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto flex flex-col items-center justify-center">
        ...
        <div className="anim-fade-zoom-up inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full mb-8 border border-white/5 bg-white/5 backdrop-blur-xl shadow-[0_0_30px_rgba(0,242,255,0.08)] transition-all duration-300 hover:bg-white/10 hover:border-white/10 hover:shadow-[0_0_30px_rgba(0,242,255,0.15)] cursor-default overflow-hidden relative group">
        ...
        <h1 className="font-heading leading-[1.05] flex flex-col items-center gap-2 select-none">
          <span className="block text-5xl sm:text-7xl md:text-8xl lg:text-[110px] xl:text-[130px] font-black tracking-[-0.04em] text-white anim-fade-zoom-up delay-100 drop-shadow-2xl">
            AI 輿情推演
          </span>
          <span className="block text-4xl sm:text-6xl md:text-7xl lg:text-[90px] xl:text-[110px] font-bold pb-4 anim-fade-zoom-up delay-200 text-neon-glow tracking-[-0.02em] text-gradient-bg">
            五步到位
          </span>
        </h1>

        <p className="mt-6 md:mt-8 text-lg sm:text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto text-slate-400 font-light tracking-wide anim-fade-zoom-up delay-300 drop-shadow-sm">
        ...
        <div className="mt-12 md:mt-16 flex flex-col sm:flex-row items-center gap-6 sm:gap-8 justify-center w-full anim-fade-zoom-up delay-500">
