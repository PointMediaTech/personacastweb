...
export function CastingArenaCard() {
  return (
    <div className="rounded-xl border border-white/[0.12] bg-gradient-to-b from-white/[0.05] to-white/[0.02] backdrop-blur-sm overflow-hidden flex flex-col shadow-[0_0_30px_rgba(255,184,0,0.05)]">
      {/* Header */}
      <div className="px-5 pt-[30px] lg:pt-[35px] pb-[22px] lg:pb-[29px]">
        <div className="text-base font-sans font-medium text-aurora-cyan/60 tracking-widest mb-1.5">[ 全域萬向推演 ]</div>
      ...
      <div className="px-4 pb-4 pt-[22px] lg:pt-[26px]">
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-lg px-[28px] lg:px-[35px] py-[22px] lg:py-[30px]">
          <div className="text-base font-sans font-medium text-aurora-cyan/60 tracking-widest mb-1.5">[ 執行：終局鎖定 ]</div>
