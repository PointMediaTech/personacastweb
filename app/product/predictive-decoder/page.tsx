...
const outputCards = [
  {
    title: '視覺化輿情路徑圖',
    description:
      '掌握每一個關鍵轉折與介入窗口。以時間軸直觀呈現最可能演化的輿論路徑，告訴你哪一刻輿論會分裂，哪一刻沉默多數會加入。',
  },
  {
    title: '動態風險評估矩陣',
    description:
      '找出最脆弱的利害關係人群體。透過熱力圖深度解析各群體的敏感度，不僅警示風險，更指引你發現潛在的發聲盟友。',
  },
  {
    title: 'AI 生成的行動劇本',
    description:
...
export default function PredictiveDecoderPage() {
  return (
    <>
      ...
      />
      <PageHero
        h1="從百萬種可能中，為你萃取「唯一最佳解」。"
        h2="預測解碼器不只預見未來，更直接對接您的決策流程。我們將《推演劇場》的千萬種平行時空，收斂成帶有信心指數的「具體行動清單」。不再依靠直覺摸黑前行——我們直接告訴你下一步該怎麼走。"
